...
public class ProyectoRestReactivoBcpApplication implements CommandLineRunner{
	...
	private static final Logger log = LoggerFactory.getLogger(ProyectoRestReactivoBcpApplication.class);
	
	public static void main(String[] args) {
		SpringApplication.run(ProyectoRestReactivoBcpApplication.class, args);
	}
